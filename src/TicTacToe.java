...
public class TicTacToe extends javax.swing.JFrame {
    ...
    private String playerOne = "player_one";
    private String playerTwo = "player_Two";
    ...
    {
   playerOne = JOptionPane.showInputDialog(this,"Enter Player_One name ","Player Name",JOptionPane.INFORMATION_MESSAGE);
   playerTwo = JOptionPane.showInputDialog(this,"Enter Player_Two name ","Player Name",JOptionPane.INFORMATION_MESSAGE);
    
   
   if(playerOne.equals(""))
   {
       playerOne = "Player_serius";
       
   }
   if(playerTwo.equals(""))
   {
       playerTwo = "Player_Agartius";
   }
    ...
    {
        jLabel_score.setText(String.valueOf(playerOneCount)+"           "+playerOne + " vs " +
                playerTwo+ "          "+String.valueOf(playerTwoCount));
    }
    ...
    private void tieGame()
    {
        ...
        (this,"Game is a tie","Tie Game",JOptionPane.INFORMATION_MESSAGE);
             resetGame();
         }
    ...
    private void initComponents() {
        ...
        jPanel1.setForeground(new java.awt.Color(10, 11, 14));
        jPanel1.setLayout(new java.awt.BorderLayout());

        jPanel2_GridHolder.setBackground(new java.awt.Color(192, 196, 203));
        ...
        jLabel_score.setFont(new java.awt.Font("Ubuntu", 1, 18)); // NOI18N
